...
from componga.util.screeninfo.common import Monitor, ScreenInfoError, calculate_dpi_density
    ...
    try:
        ...
        for i in range(screen_resources.contents.noutput):
            ...
            try:
                ...
                dpi, density = calculate_dpi_density(
                    crtc_info.contents.width,
                    crtc_info.contents.height,
                    output_info.contents.mm_width,
                    output_info.contents.mm_height
                )
