...
class ArrowStraight(LineStraight):
    ...
    def build_preview(self, pos):
        prev = ArrowStraight(pos, self.initial_color, self.line_width,  fading_enabled=False)
        prev.end_point = (500, 500)
        prev._calculate_arrowhead_points()
